          ...
          <div className="relative z-10 space-y-8 animate-fadeUp">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-lg leading-8 text-slate-600 md:text-xl">
                {chronicle.group.description}
              </p>
            </div>
            <div className="flex flex-wrap gap-4">
              <a href="#timeline" className="inline-flex items-center rounded-2xl bg-blue-600 px-6 py-3 font-semibold text-white shadow-float transition hover:bg-blue-700">
                进入时间线
